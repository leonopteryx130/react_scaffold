      ...
      <div className="max-w-1200px w-full">
        ...
        <nav className="flex justify-between items-center mb-40px p-20px bg-white rounded-8px shadow-sm">
          ...
          <div className="flex gap-16px">
            ...
            <Link to="/about" className="px-16px py-8px bg-primary text-white rounded-4px hover:opacity-80 transition-opacity">
              关于
            </Link>
        ...
        <div className="bg-white rounded-8px p-40px text-center shadow-sm">
          <h2 className="text-32px font-bold text-gray-800 mb-16px">关于我们</h2>
          <p className="text-16px text-gray-600 mb-24px">这是一个最小化的关于页面组件，展示了路由切换功能</p>
